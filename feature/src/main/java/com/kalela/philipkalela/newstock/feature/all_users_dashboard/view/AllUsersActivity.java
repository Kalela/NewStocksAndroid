package com.kalela.philipkalela.newstock.feature.all_users_dashboard.view;
...
public class AllUsersActivity extends AppCompatActivity implements UsersContract.UsersView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UsersPresenter usersPresenter = new UsersPresenter(this, RetrofitInjector.provideUsersService());
